...
Climate Change and Environment Economics, Development Economics, Computable General Equilibrium (CGE) Model
...
\begin{itemize}
    \item ``Determinants of Refugees' Return'' with Marguerite Duponchel, Erwrin Knippenberg and Daniel Kryger
...
\begin{itemize}
    \item Green Transition in Industry (EMBA, TA for Prof. Jing Cao) \hfill 2025-Autumn
    \item Environmental and Resources Economics (taught in English) (Undergraduate, TA for Prof. Jing Cao) \hfill 2025-Autumn
    \item The Situated Decision Maker (taught in English) (Ph.D., TA for Prof. Soo Hong Chew) \hfill 2025-Autumn
...
\begin{flalign*}
    &\textbf{Language}     \qquad &&\text{Chinese (Native), English (Fluent), Arabic (Beginner)} & &\qquad\qquad\qquad\qquad\qquad& &\qquad&\\
    &\textbf{Programming} \qquad  &&\text{Python, R, STATA, QGIS, GAMS, \LaTeX} & &\qquad\qquad\qquad\qquad\qquad& &\qquad&
\end{flalign*}
...
% \textbf{JING CAO} & \textbf{MUN SING HO} \\
% Tenured Associate Professor  & Economist \\
% Department of Economics & Harvard-China Project \& Resources for Future \\
% Tsinghua University & Harvard University \\
% \href{mailto:caojing@sem.tsinghua.edu.cn}{caojing@sem.tsinghua.edu.cn} & \href{mailto:munho@seas.harvard.edu}{munho@seas.harvard.edu} \\
% \\
% \textbf{MARGUERITE DUPONCHEL} & \textbf{ERWIN KNIPPENBERG} \\
% Senior Development Officer & Young Professional \& Economist \\
% UNHCR & World Bank \\
% \href{mailto:duponche@unhcr.org}{duponche@unhcr.org} & \href{mailto:eknippenberg@worldbank.org}{eknippenberg@worldbank.org} \\
% \end{tabularx}
